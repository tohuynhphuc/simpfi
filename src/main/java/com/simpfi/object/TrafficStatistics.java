...
/**
 * Computes statistics about average speed, vehicle density, travel times, and
 * congestion hotspots.
 */
...
public class TrafficStatistics {
	...
	/**
	 * Constructs a TrafficStatistics object with the given edge and vehicle
	 * controllers.
	 * 
	 * 
	...
	/**
	 * Updates the traffic statistics for the current simulation step. This method
	 * updates vehicle speeds, edge densities, and tracks travel times for vehicles
	 * exiting the network.
	 * 
	...
	/**
	 * Returns a list of recorded travel times for vehicles that have exited the
	 * network.
	 *
	...
	/**
	 * Returns a string representing the top K congestion hotspots sorted by vehicle
	 * count.
	 * 
	...
	public String getTopCongestionHostspots(int k) {
		return edgeVehicleCount.entrySet().stream().sorted((a, b) -> b.getValue() - a.getValue()).limit(k)
