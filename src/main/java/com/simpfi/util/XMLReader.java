...
public class XMLReader {
	...
	/**
	 * Used to convert a String of multiple pairs of coordinates to an array of Point.
	 * @param shape the String that contains pairs of coordinates with the format: "x,y u,t a,b ...".
